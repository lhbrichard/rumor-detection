...
class EncoderGCN(nn.Module):
    def __init__(self, n_total_features, n_latent,out_feats, p_drop=0.):
        ...
        self.conv1 = GCNConv(n_total_features, n_latent)
        ...
        self.conv3 = GCNConv(n_total_features+n_latent, out_feats)
        self.conv4 = GCNConv(n_total_features+n_latent, out_feats)
